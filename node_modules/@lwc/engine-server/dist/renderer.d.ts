...
declare function getUpgradableElement(tagName: string, _connectedCallback?: LifecycleCallback, _disconnectedCallback?: LifecycleCallback): CreateElementAndUpgrade;
declare function createCustomElement(tagName: string, upgradeCallback: LifecycleCallback): HostElement;
