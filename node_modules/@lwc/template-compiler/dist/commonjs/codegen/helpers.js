...
exports.getStaticNodes = exports.parseClassNames = exports.styleMapToStyleDeclsAST = exports.parseStyleText = exports.generateTemplateMetadata = exports.memorizeHandler = exports.hasIdAttribute = exports.shouldFlatten = exports.objectToAST = exports.getMemberExpressionRoot = exports.identifierFromComponentName = void 0;
/*
...
function shouldFlatten(codeGen, children) {
    return children.some((child) => {
        ...
        (0, ast_1.isForBlock)(child) ||
            // light DOM slots
            ((0, ast_1.isSlot)(child) && codeGen.renderMode === types_1.LWCDirectiveRenderMode.light) ||
...
function generateTemplateMetadata(codeGen) {
    ...
    if (codeGen.hasRefs) {
        const refsMetadata = t.assignmentExpression('=', t.memberExpression(t.identifier(constants_1.TEMPLATE_FUNCTION_NAME), t.identifier('hasRefs')), t.literal(true));
...
function isStaticNode(node) {
    ...
    if (namespace !== shared_1.HTML_NAMESPACE) {
...
function collectStaticNodes(node, staticNodes, state) {
    ...
    if ((0, ast_1.isText)(node)) {
        ...
        if ((0, ast_1.isConditionalParentBlock)(node) && node.else) {
