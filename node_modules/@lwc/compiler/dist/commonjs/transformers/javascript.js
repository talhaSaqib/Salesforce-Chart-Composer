...
function scriptTransform(code, filename, options) {
    const { isExplicitImport, experimentalDynamicComponent: dynamicImports, outputConfig: { sourcemap }, namespace, name, } = options;
    let result;
    try {
        result = babel.transformSync(code, {
            ...
            compact: false,
            plugins: [
                [babel_plugin_component_1.default, { isExplicitImport, dynamicImports, namespace, name }],
