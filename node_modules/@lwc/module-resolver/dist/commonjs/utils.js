...
function normalizeConfig(config, scope) {
    ...
    const normalizedModules = modules.map((m) => {
        ...
        return isDirModuleRecord(m) ? { ...m, dir: path_1.default.resolve(rootDir, m.dir) } : m;
    });
    return {
...
function findFirstUpwardConfigPath(dirname) {
    ...
    throw new errors_1.LwcConfigError(`Unable to find any LWC configuration file`, { scope: dirname });
}
